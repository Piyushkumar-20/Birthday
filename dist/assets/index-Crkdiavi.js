 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function a(y,z){var O=y.length;y.push(z);t:for(;0<O;){var j=O-1>>>1,k=y[j];if(0<u(k,z))y[j]=z,y[O]=k,O=j;else break t}}function l(y){return y.length===0?null:y[0]}function e(y){if(y.length===0)return null;var z=y[0],O=y.pop();if(O!==z){y[0]=O;t:for(var j=0,k=y.length,Oa=k>>>1;j<Oa;){var ia=2*(j+1)-1,Sl=y[ia],tl=ia+1,ru=y[tl];if(0>u(Sl,O))tl<k&&0>u(ru,Sl)?(y[j]=ru,y[tl]=O,j=tl):(y[j]=Sl,y[ia]=O,j=ia);else if(tl<k&&0>u(ru,O))y[j]=ru,y[tl]=O,j=tl;else break t}}return z}function u(y,z){var O=y.sortIndex-z.sortIndex;return O!==0?O:y.id-z.id}if(t.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var n=performance;t.unstable_now=function(){return n.now()}}else{var i=Date,c=i.now();t.unstable_now=function(){return i.now()-c}}var f=[],r=[],p=1,g=null,d=3,m=!1,x=!1,E=!1,Y=!1,s=typeof setTimeout=="function"?setTimeout:null,o=typeof clearTimeout=="function"?clearTimeout:null,h=typeof setImmediate<"u"?setImmediate:null;function b(y){for(var z=l(r);z!==null;){if(z.callback===null)e(r);else if(z.startTime<=y)e(r),z.sortIndex=z.expirationTime,a(f,z);else break;z=l(r)}}function T(y){if(E=!1,b(y),!x)if(l(f)!==null)x=!0,H||(H=!0,$t());else{var z=l(r);z!==null&&re(T,z.startTime-y)}}var H=!1,S=-1,_=5,D=-1;function R(){return Y?!0:!(t.unstable_now()-D<_)}function zt(){if(Y=!1,H){var y=t.unstable_now();D=y;var z=!0;try{t:{x=!1,E&&(E=!1,o(S),S=-1),m=!0;var O=d;try{a:{for(b(y),g=l(f);g!==null&&!(g.expirationTime>y&&R());){var j=g.callback;if(typeof j=="function"){g.callback=null,d=g.priorityLevel;var k=j(g.expirationTime<=y);if(y=t.unstable_now(),typeof k=="function"){g.callback=k,b(y),z=!0;break a}g===l(f)&&e(f),b(y)}else e(f);g=l(f)}if(g!==null)z=!0;else{var Oa=l(r);Oa!==null&&re(T,Oa.startTime-y),z=!1}}break t}finally{g=null,d=O,m=!1}z=void 0}}finally{z?$t():H=!1}}}var $t;if(typeof h=="function")$t=function(){h(zt)};else if(typeof MessageChannel<"u"){var su=new MessageChannel,qn=su.port2;su.port1.onmessage=zt,$t=function(){qn.postMessage(null)}}else $t=function(){s(zt,0)};function re(y,z){S=s(function(){y(t.unstable_now())},z)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(y){y.callback=null},t.unstable_forceFrameRate=function(y){0>y||125<y?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):_=0<y?Math.floor(1e3/y):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_next=function(y){switch(d){case 1:case 2:case 3:var z=3;break;default:z=d}var O=d;d=z;try{return y()}finally{d=O}},t.unstable_requestPaint=function(){Y=!0},t.unstable_runWithPriority=function(y,z){switch(y){case 1:case 2:case 3:case 4:case 5:break;default:y=3}var O=d;d=y;try{return z()}finally{d=O}},t.unstable_scheduleCallback=function(y,z,O){var j=t.unstable_now();switch(typeof O=="object"&&O!==null?(O=O.delay,O=typeof O=="number"&&0<O?j+O:j):O=j,y){case 1:var k=-1;break;case 2:k=250;break;case 5:k=1073741823;break;case 4:k=1e4;break;default:k=5e3}return k=O+k,y={id:p++,callback:z,priorityLevel:y,startTime:O,expirationTime:k,sortIndex:-1},O>j?(y.sortIndex=O,a(r,y),l(f)===null&&y===l(r)&&(E?(o(S),S=-1):E=!0,re(T,O-j))):(y.sortIndex=k,a(f,y),x||m||(x=!0,H||(H=!0,$t()))),y},t.unstable_shouldYield=R,t.unstable_wrapCallback=function(y){var z=d;return function(){var O=d;d=z;try{return y.apply(this,arguments)}finally{d=O}}}})(i0);n0.exports=i0;var bd=n0.exports,c0={exports:{}},St={};/**
 * @license React
